          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary">Get notified when patients book</p>
              </div>
            </div>
            <button
              onClick={() => toggleSetting('browserNotifications')}
              className={`w-12 h-6 rounded-full transition-colors ${
                settings.browserNotifications ? 'bg-[#14b6a6]' : 'bg-border'
              }`}
            >
              <span
                className={`block w-5 h-5 bg-white rounded-full shadow transition-transform ${
                  settings.browserNotifications ? 'translate-x-6' : 'translate-x-0.5'
                }`}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary">Receive booking confirmations via email</p>
              </div>
            </div>
            <button
        ...
        <div className="p-4 sm:p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary">Your data is secure and encrypted</p>
            </div>
          </div>
        </div>
      </div>
